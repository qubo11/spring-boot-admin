...
import com.expect.admin.service.convertor.custom.FunctionConvertor;
...
public class FunctionService {
	 ...
	 * 获取所有的菜单
	 */
	public List<DataTableRowVo> getFunctionDtrsv() {
	...
	public List<FunctionVo> getFunctions() {
		List<Function> functions = functionRepository.findAll();
		List<FunctionVo> functionVos = FunctionConvertor.convert(functions, false);
		return functionVos;
	}
